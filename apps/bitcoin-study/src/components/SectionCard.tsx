      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="px-8 py-8 space-y-8">
          ...
          <div>
            ...
            <MarkdownText text={section.bigPicture} className="text-base leading-7 text-gray-700" />
          </div>

          {/* Why It Matters */}
          <div className="rounded-xl bg-amber-50/60 border border-amber-100 p-5">
            <h4 className="text-xs font-bold tracking-widest text-amber-600 uppercase mb-2">
              Why This Matters
            </h4>
            <MarkdownText text={section.whyItMatters} />
          </div>
          ...
          {section.simpleExample && (
            <div className="rounded-xl bg-emerald-50/60 border border-emerald-100 p-5">
              <h4 className="text-xs font-bold tracking-widest text-emerald-600 uppercase mb-2">
                Simple Example
              </h4>
              <MarkdownText text={section.simpleExample} />
            </div>
          )}
