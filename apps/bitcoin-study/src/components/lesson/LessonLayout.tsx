  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-10 space-y-10">
      ...
      <div className="space-y-3 pt-8 lg:pt-0">
        ...
        <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 leading-relaxed">{subtitle}</p>
      </div>
        ...
        <div className="flex items-stretch justify-between gap-3">
          {prev ? (
            <button
              ...
              className="flex items-center gap-2 max-w-[48%] text-left px-3 py-2 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-amber-300 dark:hover:border-amber-700 hover:bg-amber-50/50 dark:hover:bg-amber-900/10 transition-all cursor-pointer group"
            >
              <ChevronLeft size={15} className="shrink-0 text-gray-400 group-hover:-translate-x-0.5 transition-transform" />
              <span className="min-w-0">
                <span className="block text-[10px] uppercase tracking-wider text-gray-400">Previous</span>
                <span className="block text-xs sm:text-sm text-gray-700 dark:text-gray-300 truncate">{prev.title}</span>
              </span>
            </button>
          ) : (
            <div />
          ...
          {next ? (
            <button
              ...
              className="flex items-center gap-2 max-w-[48%] text-right ml-auto px-3 py-2 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-amber-300 dark:hover:border-amber-700 hover:bg-amber-50/50 dark:hover:bg-amber-900/10 transition-all cursor-pointer group"
            >
              <span className="min-w-0">
                <span className="block text-[10px] uppercase tracking-wider text-gray-400">Next</span>
                <span className="block text-xs sm:text-sm text-gray-700 dark:text-gray-300 truncate">{next.title}</span>
              </span>
              <ChevronRight size={15} className="shrink-0 text-gray-400 group-hover:translate-x-0.5 transition-transform" />
            </button>
          ) : (
            <div />
          )}
